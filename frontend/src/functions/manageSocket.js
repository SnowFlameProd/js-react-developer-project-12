...
export const initSocket = (dispatch) => {
    ...
    socket.on(routes.server.socket.removeChannel, (payload) => dispatch(channelsActions.removeChannel(payload)));
    socket.on(routes.server.socket.renameChannel, (payload) => dispatch(channelsActions.renameChannel(payload)));
}